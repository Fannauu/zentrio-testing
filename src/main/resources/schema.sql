...
CREATE TABLE users (
                       ...
                       provider varchar(20) DEFAULT 'credential',
                       ...
                       is_reset BOOLEAN DEFAULT false  -- Fixed the typo here
);
...
CREATE TABLE comments (
                          ...
                          checklist_id UUID REFERENCES checklists(checklist_id) ON DELETE CASCADE ON UPDATE CASCADE,
                          commented_by UUID REFERENCES users(user_id) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE notifications (
                               ...
                               created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
                               task_assignment_id UUID REFERENCES task_assignment(task_assign_id) ON DELETE CASCADE ON UPDATE CASCADE,
                               user_id UUID REFERENCES users(user_id) ON DELETE CASCADE ON UPDATE CASCADE
);
